...
# 实例化代理模型的攻击
attack = AttackClass(surrogate_model_name,epsilon=16/255, alpha=1.6/255, epoch=10, targeted=False, random_start=False,
                norm='linfty', loss='crossentropy',device=None, attack='I-FGSM')
