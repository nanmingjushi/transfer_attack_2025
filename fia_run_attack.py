...
# 实例化攻击类
attack = AttackClass(model_name, epsilon ,alpha=1.6/255,epoch=10, decay=1., num_ens=30, targeted=targeted, random_start=random_start,feature_layer='layer2', norm=norm, loss=loss, device=device,  attack='FIA',drop_rate=0.3)
