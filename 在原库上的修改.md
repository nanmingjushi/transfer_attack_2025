![image-20250917114640309](https://gitee.com/nan-chao/typora-image-bed/raw/master/image-20250917114640309.png)
...
img_height, img_width = 224, 224  # 在数据加载阶段时，和最终输出到output 中的图像尺寸
...
def save_images(output_dir, adversaries, filenames, labels, adversarial_labels, targeted, imagenet_labels,confidences):
    ...
    for i, filename in enumerate(filenames):
        ...
        text += f"Ground truth: {original_label} ({original_label_idx})\n"
