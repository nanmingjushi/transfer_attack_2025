...
# 实例化代理模型的攻击
attack = AttackClass(surrogate_model_name, epsilon=epsilon, targeted=False, random_start=False, norm='linfty', loss='crossentropy',device=device)
